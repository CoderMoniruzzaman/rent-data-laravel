...
<div class="row">
  ...
  <div class="col-6 offset-5">
    <input type="text" name="search_data" id="search_data" class="form-control" value="" placeholder="Search here">
  </div>
  <div class="col-1">
    <button type="submit" class="btn btn-info" name="search_btn" id="search_btn">search</button>
  </div>
  <div class="col-12 ">
    <br>
    <div class="card">
